  ...
  return (
    <>
      <div className="flex h-screen bg-gray-50">
        <aside className={`bg-white shadow-xl flex flex-col border-r border-gray-200 transition-all duration-300 ${isCollapsed ? 'w-12' : 'w-64'}`}>
            ...
            <>
              <div className="p-4 border-b border-gray-100">
                <div className="relative">
                  <button onClick={() => setIsProfileOpen(!isProfileOpen)} className="flex items-center w-full text-left focus:outline-none hover:bg-gray-50 p-2 rounded-lg transition space-x-3">
              ...
              <div className="p-4 border-t border-gray-100">
                <button
                  onClick={logout}
                  className="flex items-center gap-2 text-red-600 hover:bg-red-50 rounded-lg transition px-4 py-2 w-full"
                >
